...
# data = pd.read_csv(pwd + "nj_woodcliff_lake_nowcast_predictions_longrun_detect.csv",parse_dates=["date"])

data = pd.read_csv(f"s3://cwa-assets/nj_woodcliff_lake/assets/now_cast_tab/nj_woodcliff_lake_nowcast_predictions_longrun_detect.csv",parse_dates=["date"])
